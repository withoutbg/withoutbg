...
For vulnerabilities in the Docker / self-hosted inference service, report via [withoutbg/withoutbg-inference](https://github.com/withoutbg/withoutbg-inference) or the same email address.
